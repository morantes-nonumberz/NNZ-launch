...
/* ─── 2. Loader ─────────────────────────────── */
// FIXED: was using window 'load' which waits for ALL resources (Spotify iframes,
// images, fonts) — if any stall, the loader never dismisses.
// Now uses DOMContentLoaded (fires once HTML is parsed) + a hard 3s max fallback.
